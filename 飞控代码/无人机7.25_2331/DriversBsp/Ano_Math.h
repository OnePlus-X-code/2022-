...
#define my_3_norm( x, y, z )                                                             \
    ( my_sqrt( my_pow( ( x ) ) + my_pow( ( y ) ) + my_pow( ( z ) ) ) )
...
float vec_2_cross_product( float in1[2], float in2[2] );
float vec_2_dot_product( float in1[2], float in2[2] );
void  vec_3_cross_product_err_sinx( float in1[3], float in2[3], float out[3] );
