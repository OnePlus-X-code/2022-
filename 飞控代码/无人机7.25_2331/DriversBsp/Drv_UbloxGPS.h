...
typedef struct
{
    ...
    */
    ...
    u32 headAcc;      // 1e-5 deg Heading accuracy estimate (both motion and
                      // vehicle)
...
//{
//	u8 updata_cnt;
//	u8 state;//0:offline 1:online but unavailable 2: online and availabal
// 3:online and works in a good state
//
//	u8 fixType;//
//	u8 numSV;// - Number of satellites used in Nav Solution
//	s32 lon;//1e-7 deg Longitude
